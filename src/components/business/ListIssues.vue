<!--
 * @Author: 殷鹏飞
 * @Date: 2020-03-14 11:04:31
 * @Description: issues 部分
-->
<template>
  <div id="list-wrapper">
    <div class="title-wrapper">Issues管理</div>
    <!-- 搜索 -->
...
export default {
  ...
  methods: {
    ...
    updateSubmit() {
      let {title} = this.form
      // 表单校验
      let mark = this.formRequired({arr: {title}, msg: '请输入必填项'})
      if(!mark)return;
      // 请求参数
      let model = {
        id: this.rowInfo.id,
